...
uint256 hashGenesisBlock("0x29f0b851c88a416a25c0f5aea171ee37d25cb54f79c73249dd7241cf568d9451");
...
const string strMessageMagic = "HaroldCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // HaroldCoin: 1 day
static const int64 nTargetSpacing = 60; // HaroldCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal haroldcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HaroldCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc88a0b5918ebf0c5a602950e547a20e285011d5740a188b56b13c29db24dacfc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "/r/youdontsurf";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
	block.nTime = 1423429652; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 630404;

        if (fTestNet)
        {
	    block.nTime = 1423429653;
            block.nNonce   = 54067;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf4f4749b24459623ed604c60eb1b22a64791d800b2e2dc674a596ab2a389aa99"));
